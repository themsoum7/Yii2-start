    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <?= Html::beginTag('li', ['class' => 'nav-item']) ?>
                <?= Html::tag('a', 'Shop', ['class' => 'nav-link', 'href' => Url::toRoute(['/shop/index'])]); ?>
                <?= Html::endTag('li') ?>

                <?= Html::beginTag('li', ['class' => 'nav-item']) ?>
                <?= Html::tag('a', 'Cart', ['class' => 'nav-link', 'href' => Url::toRoute(['/shop/cart'])]); ?>
                <?= Html::endTag('li') ?>
                ...
                if (Yii::$app->user->isGuest)
                {?>
                    <?= Html::beginTag('li', ['class' => 'nav-item']) ?><?php
                    echo Html::tag('a', 'Sign Up', ['class' => 'nav-link', 'href' => Url::toRoute(['/site/signup'])]); ?>
                    <?= Html::endTag('li') ?><?php
